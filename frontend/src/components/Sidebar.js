export default function Sidebar({ onNavigate, currentPage, onLogout }) {
  return (
    <aside className="w-72 bg-gray-50 shadow-xl h-screen flex flex-col justify-between border-r border-gray-200 fixed left-0 top-0 overflow-y-auto z-40">
      <div>
        {/* INSEE Logo Header */}
